...
## Help to improve
There can be bugs in the Designer, for instance an issue with generating a link to the template (check backslash, forward slash in copied urls). 
Please report such things [here](https://github.com/ideaconsult/templateforge/issues).
:::
