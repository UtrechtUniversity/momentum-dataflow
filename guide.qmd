...
Data planned to be published can be uploaded to YODA separately from filled ENM templates. Filled in ENM templates can be uploaded to YODA whenever they are ready, waiting until the publication is out is not necessary. 
Unpublished data should also be uploaded to YODA whenever it is ready. This data does not have to be in ENM templates. 

### Timeline
If data of the MOMENTUM projects is published in a paper, the underlying data should be uploaded in YODA in ENM templates and original formats wherever it is possible and otherwise in other formats preferably before but **maximally 2 months after the publication**. For papers that are **already published** we ask the authors to upload the data in ENM templates and original formats wherever it is possible and otherwise in other formats before **01-04-2025**. 
For data generated in **MOMENTUM1.0 (or in MOMENTUM2.0) and not used in publications**, we ask all data generators to upload this to YODA before **01-07-2025**. All data generated in **MOMENTUM2.0** should be made available before **01-07-2026**. 
...
The two ‘streams’ of MOMENTUM data (ENM and YODA) can be linked on the website of MOMENTUM or the community on ZENODO.
...
•	☐ Experimental, Tabular Data – xls, csv
e.g. Lab data (raw & processed)  	Data storage:
☐ data into enanomapper (ENM) template 
»	☐ store templates together with original data in YODA

•	☐ Experimental, Non-Tabular Data 
e.g. Output of imaging techniques, PCR	☐ store all formats in YODA 

•	☐ Non-Experimental Data
e.g. Documentation, SOPs, literature reviews, modelling output	☐ store all formats in YODA

 
Openness
•	☐ Open access 
•	☐ Restricted access – metadata is open

Required documents (in case of restricted access)
☐ protocol available for arranging data access
»	☐ e.g. contact person appointed, data-sharing agreements in place – usually institutional guidelines to be consulted

Timeline
•	☐ Already published data >> at latest within 2 months (01-04-2025)
•	☐ Upcoming papers >> maximally 2 months after the publication
•	☐ MOMENTUM 1 data >> at latest 1st July 2025
•	☐ MOMENTUM 2 data >> at latest 1st July 2026
